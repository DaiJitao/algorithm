...
from dl.backend import keras, K, is_tf_keras
from dl.backend import align, sequence_masking
from dl.backend import recompute_grad
from dl.backend import attention_normalize
from dl.backend import sinusoidal_embeddings
from dl.backend import apply_rotary_position_embeddings
...
class GlobalPointer(Layer):
    ...
    def compute_output_shape(self, input_shape): # input_shape=(None, None, 768)
