...
from dl.snippets import is_string, is_py2
from dl.snippets import open
from dl.snippets import convert_to_unicode
from dl.snippets import truncate_sequences
from dl.snippets import lowercase_and_normalize
